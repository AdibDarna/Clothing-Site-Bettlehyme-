    ...
    <div class="con-relative" style="height: 80vh">
        ...
        <div class="container">
            ...
            <div class="section-container">
                ...
                <div class="container2" style="margin-top: 1vw">
                    @foreach ($catalog as $c)
                        <a href="/catalogue/{{ $c->id_produk }}" style="text-decoration: none">

                            <div class="item">
                                @foreach ($fotoCatalog as $f)
                                    @if ($f->id_produk == $c->id_produk)
                                        <img src="{{ asset('img/foto_produk/' . $f->photo_name) }}">
                                    @endif
                                @endforeach
                                <div class="item-text">{{ $c->nama_produk }}</div>
                                <div class="item-text" style="color:grey">Rp. {{ number_format($c->harga) }}
                                    {{-- <div class="crossprice">Rp. {{ number_format(200000) }}</div> --}}
                                </div>
